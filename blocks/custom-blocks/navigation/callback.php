<?php
function zenfse_barbone_render_navigation_block($attributes)
{
  ...
  if (isset($desktop_menu_id)) {
    $menu_html .= zenfse_barbone_generate_desktop_menu_html($desktop_menu_id);
  }
  if (isset($mobile_menu_id)) {
    $menu_html .= zenfse_barbone_generate_mobile_menu_html($mobile_menu_id);
  }
...
function zenfse_barbone_generate_desktop_menu_html($menu_id)
{
...
function zenfse_barbone_generate_mobile_menu_html($menu_id)
{
  $html_mobile = '
