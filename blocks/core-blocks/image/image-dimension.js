...
addFilter("blocks.registerBlockType", "zenfse_barbone-core-blocks/image-height/add-attributes", addAttributes);
...
addFilter("editor.BlockEdit", "zenfse_barbone-core-blocks/image-height/add-inspector-controls", addInspectorControl);

addFilter(
  "blocks.getEditWrapperProps",
  "zenfse_barbone-core-blocks/image-size/add-wrapper-props",
...
addFilter(
  ...
  "zenfse_barbone-core-blocks/image-size/add-front-end-class",
